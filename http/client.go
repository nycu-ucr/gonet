...
func send(ireq *Request, rt RoundTripper, deadline time.Time) (resp *Response, didTimeout func() bool, err error) {
	...
	// println("/usr/local/go/src/net/http/client.go RoundTrip")
	resp, err = rt.RoundTrip(req)
	if err != nil {
		// println("/usr/local/go/src/net/http/client.go RoundTrip", err.Error())
	}
...
// unclosed.
var ErrUseLastResponse = errors.New("github.com/nycu-ucr/gonet/http: use last response")
